...
<div class="alert alert-warning" role = "alert">
	<?php if($dashboard_data->current == "enroute"){ ?>
		Hello. A panel has been sent to you from NHRL. Please be sure to confirm upon receiving them. If you have received it, <a href="#">click here</a> to confirm receipt.
	...
	<div class="col-md-8">
		<div class="card">
			<div class="card-header">
				...
				<div class="col-sm-4">
					<a href = "#" class = "btn btn-primary pull-right">Open Round</a>
				</div>
			</div>
