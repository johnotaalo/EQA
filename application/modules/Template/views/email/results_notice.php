	...
	<tr>
		...
		<td class="container" width="600">
			<div class="content">
                ...
                <tr>
                  <td class="content-block">
                    <h4>This to notify you that your flow cytometry EQA panel results from the NHRL proficiency testing programme are available online. Please log in to view</h4>
                  </td>
                </tr>
				<tr>
