...
CHANGE COLUMN `panel_condition` `sample_tubes` INT(11) NULL DEFAULT NULL ,
ADD COLUMN `insufficient_volume` INT NULL AFTER `sample_tubes`,
ADD COLUMN `haemolysed_sample` INT NULL AFTER `insufficient_volume`,
ADD COLUMN `clotted_sample` INT NULL AFTER `haemolysed_sample`,
ADD COLUMN `duplicate_sample` INT NULL AFTER `clotted_sample`,
ADD COLUMN `missing_sample` INT NULL AFTER `duplicate_sample`,
ADD COLUMN `mismatch` INT NULL AFTER `missing_sample`;
