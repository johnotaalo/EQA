ALTER TABLE `eqa`.`participant_readiness` 
ADD COLUMN `lab_result` INT NULL DEFAULT 0 AFTER `date_of_submission`;
...
ALTER TABLE `eqa`.`participant_readiness` 
CHANGE COLUMN `pt_round_no` `pt_round_no` VARCHAR(255) NOT NULL AFTER `uuid`,
ADD COLUMN `participant_facility` VARCHAR(255) NULL AFTER `participant_id`;
