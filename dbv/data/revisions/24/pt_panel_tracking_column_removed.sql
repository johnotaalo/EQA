...
DROP COLUMN `mismatch`,
DROP COLUMN `missing_sample`,
DROP COLUMN `duplicate_sample`,
DROP COLUMN `clotted_sample`,
DROP COLUMN `haemolysed_sample`,
DROP COLUMN `insufficient_volume`,
DROP COLUMN `tubes_cracked`,
DROP COLUMN `tubes_leaking`,
DROP COLUMN `tubes_broken`;
