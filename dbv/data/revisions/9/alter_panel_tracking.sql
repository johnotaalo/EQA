ALTER TABLE `pt_panel_tracking`
	ADD COLUMN `panel_condition` INT NULL AFTER `participant_received_date`,
	ADD COLUMN `panel_condition_comment` INT NULL AFTER `panel_condition`,
	ADD COLUMN `panel_received_entered` DATETIME NULL AFTER `panel_condition_comment`;

ALTER TABLE `pt_panel_tracking`
	CHANGE COLUMN `panel_condition_comment` `panel_condition_comment` TEXT NULL DEFAULT NULL AFTER `panel_condition`;
